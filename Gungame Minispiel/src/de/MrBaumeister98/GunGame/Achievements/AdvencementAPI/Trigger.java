...
public class Trigger {
    ...
    public static class TriggerBuilder {
        ...
        public String toString() {
            return /*"io.chazza.advancementapi*/"de.MrBaumeister98.GunGame.Achievements.AdvancementAPI.Trigger.TriggerBuilder(type=" + this.type + ", name=" + this.name + ", conditions=" + this.conditions + ")";
        }
    }
}